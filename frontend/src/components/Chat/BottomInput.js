...
const ButtomInput = ({ onSubmit }) => {
  ...
  return (
    <>
    <div className="h-32 md:h-4 flex-shrink-0 flex justify-center items-center">
        <form className="fixed bottom-2 w-1/2 outline-none">
          <form className="stretch mx-2 flex flex-row gap-3 last:mb-2 md:mx-4 md:last:mb-6 lg:mx-auto lg:max-w-2xl xl:max-w-3xl">
          <div className="h-full flex-1 md:flex-col">
          <div className="flex flex-col w-full py-2 flex-grow md:py-3 md:pl-4 relative border border-black/10 bg-white dark:border-gray-900/50 dark:text-white dark:bg-gray-700 rounded-md shadow-[0_0_10px_rgba(0,0,0,0.10)] dark:shadow-[0_0_15px_rgba(0,0,0,0.10)]">
            <textarea
              tabindex="0"
              className="m-0 w-full resize-none border-0 bg-transparent p-0 pr-7 text-base focus:ring-0 focus-visible:ring-0 dark:bg-transparent pl-2 md:pl-0 outline-none"
              type="search"
              ...
              rows="1"
              style={{ maxHeight: "200px", height: "24px", overflowY: "hidden", color: "black"}}
            />
